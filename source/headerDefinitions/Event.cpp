...
bool EventComparer::comp(Event first, Event second) 
{
    // counterintuitivly, The "Lesser" event is the one that comes after the Greater event. This implementation is correct because the priority queue orders them correctly when it is like this. 
